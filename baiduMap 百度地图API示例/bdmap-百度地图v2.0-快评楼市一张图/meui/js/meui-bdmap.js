                ...
                function createBdmap(){
                    ...
                    */
                    ...
                    if(isBindNode){ //有绑定节点
                        ...
                        if($(map_id).length == 0){
                            if(dPosition == 'absolute') $this.after(allHTML);
                            else $('body').prepend(allHTML);
                    ...
                    if(dPickup){ //当开启坐标拾取系统
                        var boxValue = tagname == 'input' || tagname == 'textarea' ? $this.val() : $this.text();
                        var _isVP = utilities.stringIsCoordinate(boxValue) ? true : false;
                        addCenterMarker(dPoint, dLabel, _isVP);
                    }else{
